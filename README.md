...
📥 **[Descargar `pbiDatePickerPopupCF01.2.9.7.0.pbiviz` en GitHub Releases](https://github.com/m9granado/pbi-datepicker/releases/download/v2.9.7.0/pbiDatePickerPopupCF01.2.9.7.0.pbiviz)** — impórtalo directamente en Power BI Desktop o Service.
